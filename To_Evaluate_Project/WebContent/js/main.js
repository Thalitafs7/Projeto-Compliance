...
var session_id = 'fd56d465-5dfc-483a-8283-e59fa0d46476';

function carregarDados() {
    let input = document.querySelector("#pergunta");
    if(input.value) criarMensagem(input.value, "me");
    let xhr = new XMLHttpRequest();
    xhr.open("GET", `https://node-red-gabrielcarv.mybluemix.net/evaluate?mensagem=${input.value ? input.value : ""}&session_id=${session_id}`);
